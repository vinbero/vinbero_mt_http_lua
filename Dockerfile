...
RUN git clone https://github.com/vinbero/vinbero_tcp_mt_epoll /usr/src/vinbero_tcp_mt_epoll
...
RUN mkdir /usr/src/vinbero_tcp_mt_epoll/build; cd /usr/src/vinbero_tcp_mt_epoll/build; cmake -DCMAKE_INSTALL_PREFIX:PATH=/usr ..; make; make test; make install
