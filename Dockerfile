...
RUN git clone --recurse-submodules -j8 https://github.com/vinbero/vinbero_tcp /usr/src/vinbero_tcp
RUN git clone --recurse-submodules -j8 https://github.com/vinbero/vinbero_mt /usr/src/vinbero_mt
